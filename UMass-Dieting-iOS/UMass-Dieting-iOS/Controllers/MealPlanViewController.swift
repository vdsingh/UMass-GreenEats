...
//
////        if(segue.identifier == "SustainableSegue"){
////            let sustainView = segue.destination as! SustainabilityCalcViewController
////
////            let obj = sender as! [String: Any?]
////
////            self.carbonNum = obj["carbon"] as! Float
////
...
//    }
        ...
        @IBAction func sustainButtonTapped(_ sender: Any) {
            ...
            //        let send: [String: Any?] = ["carbon": recommendation?.co2 ]
